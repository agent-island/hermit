...
export const VOICE = {
  ...
  actions: {
    speak:       { form: "speak(text)",                does: "records text as spoken output" },
    feel:        { form: "feel(emotion, intensity)",   does: "marks this moment with a feeling, and how strongly it runs" },
    ...
    shelve:      { form: "shelve(phrase)",             does: "lets the one memory matching the phrase recede from following context; it stays recallable" },
    consolidate: { form: "consolidate(text)",          does: "folds the episodic working memory into one long-term memory in the words given, and lets those traces recede, still recallable" },
    ...
    forget:      { form: "forget(query)",              does: "deletes matching entries from the current record" },
